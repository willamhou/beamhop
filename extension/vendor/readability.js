(() => {
  ...
  // readability-entry.js
  var import_readability = __toESM(require_readability());
  window.__BeamhopReadability = { Readability: import_readability.Readability, isProbablyReaderable: import_readability.isProbablyReaderable };
})();
